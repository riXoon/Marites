        ...
        <button class="dropdown-btn1"> 
             ...
             <div class="dropdown-container1">
                ...
                <div class="dropdown-container2">
                 <a href="policy.php" class="PrivPol-container"> Privacy policy </a> <br>
  ...
  <div class="container">
   <form method="POST" id="post_form">
    <div class="form-group">
     <textarea name="post_content" id="post_content" class="form-control" placeholder="Create a post" rows="5"></textarea>
    </div>
